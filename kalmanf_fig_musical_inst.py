...
y, fs = sf.read('freesound_flute_65507.wav')
...
#%
# tikzplotlib.save("./Fig_musicalinst/Fig_mi.tex") 

# # Write Text file with the Simulation parameters used
# with open ('./Fig_musicalinst/KalmANF_MusicalInst_Parameters.txt', 'w') as file:  
