...
# tikzplotlib.save("./Fig1/Norm_Mis_Fig1.tex")
plt.savefig('../results/Fig1/Norm_Mis_Fig1.pdf') 
...
with open ('../results/Fig1/KalmANF_MonteCarlo_Sim_Parameters.txt', 'w') as file:  
